...
public enum AgentEnum {
	...
	RESEARCH_AGENT("researchAgent"), CODER_AGENT("coderAgent"), COORDINATOR_AGENT("coordinatorAgent"),
	PLANNER_AGENT("plannerAgent"), REPORTER_AGENT("reporterAgent"), INTERACTION_AGENT("interactionAgent"),
	INFO_CHECK_AGENT("infoCheckAgent"), REFLECTION_AGENT("reflectionAgent");
