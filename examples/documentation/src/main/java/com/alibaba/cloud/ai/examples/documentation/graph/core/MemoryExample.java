...
public class MemoryExample {
    ...
    public static void longTermMemoryWithDatabase() throws GraphStateException {
        ...
        Map<String, Object> result = graph.invoke(Map.of("userId", "user_001"), config);
    ...
    public static void longTermMemoryWithRedis() throws GraphStateException {
        ...
        Map<String, Object> result1 = graph.invoke(Map.of("cacheKey", "expensive_key"), config);
        System.out.println("第一次调用结果: " + result1.get("result"));

        // 第二次调用（缓存命中）
        Map<String, Object> result2 = graph.invoke(Map.of("cacheKey", "expensive_key"), config);
