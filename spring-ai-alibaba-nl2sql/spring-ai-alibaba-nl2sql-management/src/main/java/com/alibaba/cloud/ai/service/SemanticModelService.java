...
public class SemanticModelService {
    ...
    private void initSampleData() {
        ...
        save(new SemanticModel("dataset_001", "product_name", "商品名称", "产品名,商品", "商品的名称信息", false, true, "VARCHAR", "商品名称字段"));
        save(new SemanticModel("dataset_002", "order_amount", "订单金额", "金额,价格,费用", "订单的总金额", true, true, "DECIMAL", "订单金额字段"));
    }
    ...
    public List<SemanticModel> findByDatasetId(String datasetId) {
        return modelStore.values().stream()
