...
public class DatasourceController {
    ...
    public ResponseEntity<Map<String, Object>> addDatasourceToAgent(
    ...
    public ResponseEntity<Map<String, Object>> removeDatasourceFromAgent(
            @PathVariable Integer agentId,
    ...
    public ResponseEntity<Map<String, Object>> toggleDatasourceForAgent(
            @PathVariable Integer agentId,
            @PathVariable Integer datasourceId,
        ...
        try {
            ...
            AgentDatasource agentDatasource = datasourceService.toggleDatasourceForAgent(agentId, datasourceId, isActive);
            Map<String, Object> response = new HashMap<>();
            response.put("success", true);
