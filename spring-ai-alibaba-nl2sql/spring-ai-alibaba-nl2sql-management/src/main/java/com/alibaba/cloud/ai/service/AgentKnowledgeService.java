...
public class AgentKnowledgeService {
    ...
    public List<AgentKnowledge> searchKnowledge(Integer agentId, String keyword) {
        ...
        return jdbcTemplate.query(sql, new BeanPropertyRowMapper<>(AgentKnowledge.class), 
                                 agentId, searchPattern, searchPattern, searchPattern);
    }
