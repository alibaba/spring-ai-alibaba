...
public class PromptConstant {
	...
	public static final PromptTemplate QUESTION_TO_KEYWORDS_PROMPT_TEMPLATE = new PromptTemplate(QUESTION_TO_KEYWORDS_PROMPT_STRING);
	...
	public static final PromptTemplate MIX_SQL_GENERATOR_SYSTEM_PROMPT_TEMPLATE = new PromptTemplate(MIX_SQL_GENERATOR_SYSTEM_PROMPT_STRING);
	...
	public static final PromptTemplate MIX_SQL_GENERATOR_PROMPT_TEMPLATE = new PromptTemplate(MIX_SQL_GENERATOR_PROMPT_STRING);
	...
	public static final PromptTemplate EXTRACT_DATETIME_PROMPT_TEMPLATE = new PromptTemplate(EXTRACT_DATETIME_PROMPT_STRING);
}