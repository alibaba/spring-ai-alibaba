...
public class Nacos2McpSseClientAutoConfiguration {

	private static final Logger logger = LoggerFactory.getLogger(Nacos2McpSseClientAutoConfiguration.class);

	public Nacos2McpSseClientAutoConfiguration() {
	}
	...
	public Map<String, List<NamedClientMcpTransport>> server2NamedTransport(
			Nacos2McpSseClientProperties nacosMcpSseClientProperties, NamingService namingService,
