...
// import
/// com.alibaba.cloud.ai.dashscope.api.DashScopeApi.ChatCompletionMessage.ChatCompletionFunction;
// import
...
//
// public DashScopeChatModel(DashScopeApi dashscopeApi, DashScopeChatOptions options,
// FunctionCallbackResolver functionCallbackResolver, List<FunctionCallback>
/// toolFunctionCallbacks,
// RetryTemplate retryTemplate) {
//
// this(dashscopeApi, options, functionCallbackResolver, toolFunctionCallbacks,
/// retryTemplate,
...
// "The default function callbacks must be set via the toolFunctionCallbacks constructor
/// parameter");
...
// Assert.isTrue(!CollectionUtils.isEmpty(prompt.getInstructions()), "Prompt messages must
/// not be empty");
//
...
// .requestOptions(prompt.getOptions() != null ? prompt.getOptions() :
/// this.defaultOptions)
// .build();
//
...
// Set.of(ChatCompletionFinishReason.TOOL_CALLS.name(),
// ChatCompletionFinishReason.STOP.name()))) {
