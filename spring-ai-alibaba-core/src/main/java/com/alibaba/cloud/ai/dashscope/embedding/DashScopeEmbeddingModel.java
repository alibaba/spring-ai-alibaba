...
// import
/// org.springframework.ai.embedding.observation.EmbeddingModelObservationDocumentation;
...
/// LoggerFactory.getLogger(DashScopeEmbeddingModel.class);
//
...
// this(dashScopeApi, metadataMode, dashScopeEmbeddingOptions,
/// RetryUtils.DEFAULT_RETRY_TEMPLATE);
// }
//
// public DashScopeEmbeddingModel(DashScopeApi dashScopeApi, MetadataMode metadataMode,
// DashScopeEmbeddingOptions dashScopeEmbeddingOptions, RetryTemplate retryTemplate) {
// this(dashScopeApi, metadataMode, dashScopeEmbeddingOptions, retryTemplate,
/// ObservationRegistry.NOOP);
// }
//
// public DashScopeEmbeddingModel(DashScopeApi dashScopeApi, MetadataMode metadataMode,
// DashScopeEmbeddingOptions options, RetryTemplate retryTemplate, ObservationRegistry
/// observationRegistry) {
...
// DashScopeEmbeddingOptions requestOptions = mergeOptions(request.getOptions(),
/// this.defaultOptions);
...
// }
//
// var metadata = generateResponseMetadata(apiRequest.model(),
...
// return new DashScopeApi.EmbeddingRequest(request.getInstructions(),
...
// * use in the request.
// */
// private DashScopeEmbeddingOptions mergeOptions(@Nullable EmbeddingOptions
/// runtimeOptions,
...
// .withModel(ModelOptionsUtils.mergeOption(runtimeOptions.getModel(),
/// defaultOptions.getModel()))
// .withDimensions(
// ModelOptionsUtils.mergeOption(runtimeOptions.getDimensions(),
...
// */
// public void setObservationConvention(EmbeddingModelObservationConvention
