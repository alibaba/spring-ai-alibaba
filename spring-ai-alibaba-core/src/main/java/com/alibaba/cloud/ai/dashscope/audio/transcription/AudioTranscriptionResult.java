...
public class AudioTranscriptionResult implements ModelResult<String> {
	...
	private DashScopeAudioTranscriptionMetadata transcriptionMetadata;
	...
	public ResultMetadata getMetadata() {
		...
		return transcriptionMetadata != null ? transcriptionMetadata : DashScopeAudioTranscriptionMetadata.NULL;
	}
