...
public class SpeechResponse implements ModelResponse<Speech> {
	...
	private final DashScopeAudioSpeechResponseMetadata speechResponseMetadata;
	...
	public SpeechResponse(Speech speech) {
		this(speech, DashScopeAudioSpeechResponseMetadata.NULL);
	}
	 ...
	 * SpeechResponse
	 * @see Speech
	 * @see DashScopeAudioSpeechResponseMetadata
	 */
	public SpeechResponse(Speech speech, DashScopeAudioSpeechResponseMetadata speechResponseMetadata) {
	...
	@Override
	public DashScopeAudioSpeechResponseMetadata getMetadata() {
