...
public class AudioTranscriptionContext extends Observation.Context {
	...
	public AudioTranscriptionPrompt getPrompt() {
		return prompt;
	}

	public void setPrompt(AudioTranscriptionPrompt prompt) {
		this.prompt = prompt;
	}

	public AudioTranscriptionResponse getResponse() {
		return response;
	}

	public void setResponse(AudioTranscriptionResponse response) {
