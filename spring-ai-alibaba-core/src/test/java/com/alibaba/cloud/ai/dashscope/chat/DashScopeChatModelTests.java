...
// ChatCompletionMessage chunkMessage1 = new ChatCompletionMessage("I'm ",
/// ChatCompletionMessage.Role.ASSISTANT);
// ChatCompletionMessage chunkMessage2 = new ChatCompletionMessage("doing ",
/// ChatCompletionMessage.Role.ASSISTANT);
// ChatCompletionMessage chunkMessage3 = new ChatCompletionMessage("well!",
/// ChatCompletionMessage.Role.ASSISTANT);
//
...
// ChatCompletionChunk chunk3 = new ChatCompletionChunk(TEST_REQUEST_ID, output3, new
/// TokenUsage(10, 5, 15));
//
...
// String toolCallResponse = "{\"name\": \"get_weather\", \"arguments\":
/// \"{\\\"location\\\": \\\"Beijing\\\"}\"}";
...
// TokenUsage usage = new TokenUsage(0, 0, 0);
//
// ChatCompletionOutput toolOutput = new ChatCompletionOutput(toolCallResponse,
/// List.of(toolChoice));
...
//
// ChatCompletionMessage message1 = new ChatCompletionMessage(chunk1,
/// ChatCompletionMessage.Role.ASSISTANT);
// ChatCompletionMessage message2 = new ChatCompletionMessage(chunk2,
/// ChatCompletionMessage.Role.ASSISTANT);
// ChatCompletionMessage message3 = new ChatCompletionMessage(chunk3,
/// ChatCompletionMessage.Role.ASSISTANT);
//
...
// // Test error handling
// when(dashScopeApi.chatCompletionEntity(any())).thenThrow(new RuntimeException("API
/// Error"));
//
...
//
// assertThatThrownBy(() ->
/// chatModel.call(prompt)).isInstanceOf(RuntimeException.class).hasMessage("API Error");
// }
//
// @Test
...
// assertThatThrownBy(() ->
/// chatModel.call(emptyPrompt)).isInstanceOf(IllegalArgumentException.class)
...
// Prompt prompt = null;
// assertThatThrownBy(() ->
/// chatModel.call(prompt)).isInstanceOf(IllegalArgumentException.class)
// .hasMessageContaining("Prompt");
// }
//
// @Test
...
// Prompt prompt = new Prompt(List.of(message));
//
// Map<String, Object> customMetadata = Map.of("custom_field", "custom_value",
/// "timestamp",
...
/// DashScopeChatOptions.builder().withModel("invalid-model").build();
//
// DashScopeChatModel invalidModel = new DashScopeChatModel(dashScopeApi, invalidOptions);
// Message message = new UserMessage(TEST_PROMPT);
// Prompt prompt = new Prompt(List.of(message));
//
// when(dashScopeApi.chatCompletionEntity(any())).thenThrow(new RuntimeException("Invalid
/// model name"));
//
// assertThatThrownBy(() ->
/// invalidModel.call(prompt)).isInstanceOf(RuntimeException.class)
...
// ChatCompletionMessage.Role.ASSISTANT);
// Choice choice = new Choice(ChatCompletionFinishReason.STOP, responseMessage);
// ChatCompletionOutput output = new ChatCompletionOutput("It's sunny today!",
/// List.of(choice));
// // Add non-null TokenUsage with zero values
// TokenUsage usage = new TokenUsage(0, 0, 0);
// ChatCompletion completion = new ChatCompletion("test-id", output, usage);
...
// when(dashScopeApi.chatCompletionEntity(any())).thenReturn(ResponseEntity.ok(completion));
//
// Prompt prompt = new Prompt(List.of(systemMessage, userMessage1, assistantMessage,
/// userMessage2));
// ChatResponse response = chatModel.call(prompt);
//
// assertThat(response).isNotNull();
