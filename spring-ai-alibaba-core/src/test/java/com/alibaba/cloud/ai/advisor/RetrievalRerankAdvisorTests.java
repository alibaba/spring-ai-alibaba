...
class RetrievalRerankAdvisorTests {
	...
	// RetrievalRerankAdvisor advisor = new RetrievalRerankAdvisor(vectorStore,
	// rerankModel);
	...
	// AdvisedResponse mockResponse = new AdvisedResponse(testResponse.response(),
	// adviseContext);
	//
	// // 设置 Mock 行为
	// when(vectorStore.similaritySearch(any(SearchRequest.class))).thenReturn(documents);
	// when(rerankModel.call(any(RerankRequest.class))).thenReturn(new
	// RerankResponse(List.of(documentWithScore)));
	...
	// Map<String, Object> adviseContext = new HashMap<>();
	// adviseContext.put(RetrievalRerankAdvisor.RETRIEVED_DOCUMENTS,
	...
	//
	// // 执行测试
	// Flux<AdvisedResponse> responseFlux = advisor.aroundStream(testRequest,
	// streamChain);
	//
	// // 验证响应
	...
	// responseContext.put(RetrievalRerankAdvisor.RETRIEVED_DOCUMENTS,
	// List.of(testDocument));
	// AdvisedResponse mockResponse = new AdvisedResponse(testResponse.response(),
	// responseContext);
	//
	// // 设置 Mock 行为
