...
// defaultOptions =
/// DashScopeEmbeddingOptions.builder().withModel(TEST_MODEL).withTextType(TEST_TEXT_TYPE).build();
...
// EmbeddingList embeddingList = new EmbeddingList(TEST_REQUEST_ID, null, null,
/// embeddings, usage);
...
// List<Embedding> embeddingList = Arrays.asList(new Embedding(0, vector1), new
/// Embedding(1, vector2));
// Embeddings embeddings = new Embeddings(embeddingList);
// EmbeddingUsage usage = new EmbeddingUsage(20L);
// EmbeddingList response = new EmbeddingList(TEST_REQUEST_ID, null, null, embeddings,
/// usage);
...
// EmbeddingList errorResponse = new EmbeddingList(TEST_REQUEST_ID, "ERROR_CODE", "Error
/// message", null,
...
// assertThatThrownBy(() -> embeddingModel.embed((Document)
...
// EmbeddingList emptyResponse = new EmbeddingList(TEST_REQUEST_ID, null, null, new
/// Embeddings(List.of()), usage);
