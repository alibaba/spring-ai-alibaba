...
// DashScopeApi.FunctionTool.Function function = new
/// DashScopeApi.FunctionTool.Function("Test function", "test",
// "{}");
...
/// DashScopeChatOptions.builder().withResponseFormat(responseFormat).build();
//
