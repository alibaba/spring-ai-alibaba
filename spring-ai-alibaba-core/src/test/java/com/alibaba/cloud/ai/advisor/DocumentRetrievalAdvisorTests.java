...
class DocumentRetrievalAdvisorTests {
	...
	//
	// private static final String TEST_DOCUMENT_TEXT = "Spring AI is a framework for
	...
	// adviseContext.put(DocumentRetrievalAdvisor.RETRIEVED_DOCUMENTS,
	...
	// response.adviseContext().get(DocumentRetrievalAdvisor.RETRIEVED_DOCUMENTS);
