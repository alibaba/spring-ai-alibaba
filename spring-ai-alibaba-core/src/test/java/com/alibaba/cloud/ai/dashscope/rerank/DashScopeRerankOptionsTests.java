...
/**
 * Test cases for DashScopeRerankOptions.
 * Tests cover default values, builder pattern, and property modifications.
 *
 * @author yuluo
...
class DashScopeRerankOptionsTests {
    ...
    /**
     * Test default values of DashScopeRerankOptions.
     * Verifies that a newly created instance has the expected default values:
     * - model = "gte-rerank"
     * - topN = 3
     ...
     * and are correctly assigned to the created instance.
     */
    @Test
     ...
     * Verifies that all properties can be modified after instance creation
     * using setter methods and retrieved using getter methods.
     */
    @Test
     ...
     * Verifies that when only some properties are set using the builder,
     * the unset properties retain their default values.
     */
    @Test
