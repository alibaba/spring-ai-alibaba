...
public class ChatClientObservationContextHandler implements ContextHandler<ChatClientObservationContext> {
	...
	public ChatClientObservationContextHandler(ObservationServiceImpl observationService,
	...
	private ObservationEntity buildObservationEntity(ChatClientObservationContext modelContext, long duration,
	...
	private ObservationDetailEntity buildObservationDetailEntity(ChatClientObservationContext modelContext,
