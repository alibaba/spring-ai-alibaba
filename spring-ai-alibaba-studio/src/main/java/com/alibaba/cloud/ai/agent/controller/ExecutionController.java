...
import com.alibaba.cloud.ai.agent.agui.AGUIEvent;
...
public class ExecutionController {
  ...
  public NodeOutput agentRun(@RequestBody AgentRunRequest request) {
    ...
    try {
        ...
        RunnableConfig runnableConfig = RunnableConfig.builder().threadId(request.sessionId).addMetadata("user_id", request.userId).build();
