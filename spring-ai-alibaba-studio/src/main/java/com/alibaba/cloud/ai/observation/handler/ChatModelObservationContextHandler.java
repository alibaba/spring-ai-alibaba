...
public class ChatModelObservationContextHandler implements ContextHandler<ChatModelObservationContext>{
    ...
    public ChatModelObservationContextHandler(ObservationServiceImpl observationService, ObservationDetailServiceImpl modelObservationDetailService) {
    ...
    private ObservationEntity buildObservationEntity(ChatModelObservationContext modelContext, long duration, long timestampInMillis) {
    ...
    private ObservationDetailEntity buildObservationDetailEntity(ChatModelObservationContext modelContext, String modelObservationId, long timestampInMillis) {
