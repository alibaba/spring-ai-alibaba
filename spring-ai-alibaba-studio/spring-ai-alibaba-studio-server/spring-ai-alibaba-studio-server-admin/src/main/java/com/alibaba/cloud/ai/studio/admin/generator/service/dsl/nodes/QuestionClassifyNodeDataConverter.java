...
public class QuestionClassifyNodeDataConverter extends AbstractNodeDataConverter<QuestionClassifierNodeData> {
	...
	public void postProcess(QuestionClassifierNodeData data, String varName) {
		...
		data.setOutputs(List.of(new com.alibaba.cloud.ai.studio.admin.generator.model.Variable(data.getOutputKey(),
				com.alibaba.cloud.ai.studio.admin.generator.model.VariableType.STRING.value())));
	}
