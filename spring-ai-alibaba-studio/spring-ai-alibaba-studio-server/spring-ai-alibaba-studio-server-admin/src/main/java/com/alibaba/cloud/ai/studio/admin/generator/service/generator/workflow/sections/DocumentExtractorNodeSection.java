...
import com.alibaba.cloud.ai.studio.admin.generator.model.workflow.nodedata.DocumentExtractorNodeData;
...
public class DocumentExtractorNodeSection implements NodeSection<DocumentExtractorNodeData> {
	...
	public String render(Node node, String varName) {
		...
		List<com.alibaba.cloud.ai.studio.admin.generator.model.VariableSelector> inputs = data.getInputs();
