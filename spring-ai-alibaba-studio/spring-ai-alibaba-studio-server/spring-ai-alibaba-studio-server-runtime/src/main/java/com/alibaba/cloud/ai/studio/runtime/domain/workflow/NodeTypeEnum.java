...
public enum NodeTypeEnum {
	...
	JUDGE("Judge", "判断节点"), RETRIEVAL("Retrieval", "知识库节点"), API("API", "Api调用节点"),
	STREAM_HTTP("StreamHttp", "流式HTTP节点"), PLUGIN("Plugin", "插件节点"), MCP("MCP", "MCP节点"),
	PARAMETER_EXTRACTOR("ParameterExtractor", "参数提取节点"), ITERATOR_START("IteratorStart", "循环体开始节点"),
	ITERATOR("Iterator", "循环节点"), ITERATOR_END("IteratorEnd", "循环体结束节点"), PARALLEL_START("ParallelStart", "批处理开始节点"),
	PARALLEL("Parallel", "批处理节点"), PARALLEL_END("ParallelEnd", "批处理结束节点"), END("End", "结束节点");
