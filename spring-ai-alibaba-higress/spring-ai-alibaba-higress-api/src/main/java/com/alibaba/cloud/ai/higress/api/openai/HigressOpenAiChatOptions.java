...
import com.alibaba.cloud.ai.higress.api.openai.HigressOpenAiApi.ChatCompletionRequest.AudioParameters;
import com.alibaba.cloud.ai.higress.api.openai.HigressOpenAiApi.ChatCompletionRequest.StreamOptions;
import com.alibaba.cloud.ai.higress.api.openai.HigressOpenAiApi.ChatCompletionRequest.ToolChoiceBuilder;
import com.alibaba.cloud.ai.higress.api.openai.HigressOpenAiApi.ChatCompletionRequest.WebSearchOptions;
...
public class HigressOpenAiChatOptions implements ToolCallingChatOptions {
	 ...
	 */
	private @JsonProperty("tools") List<HigressOpenAiApi.FunctionTool> tools;
	/**
     ...
     * Whether to enable the webSearch process of the model.
     */
    private @JsonProperty("search_options") HigressOpenAiApi.QwenOpenAiCompatibleSearchOptions searchOptions;

    /**
     * Parameters for adapting the Qwen model call with Bai_Lian platform
     * Whether to enable incremental output
     */
	...
	public static HigressOpenAiChatOptions fromOptions(HigressOpenAiChatOptions fromOptions) {
		return HigressOpenAiChatOptions.builder()
			...
			.enableSearch(fromOptions.getEnableSearch())
	...
	public List<HigressOpenAiApi.FunctionTool> getTools() {
		return this.tools;
	}

	public void setTools(List<HigressOpenAiApi.FunctionTool> tools) {
		this.tools = tools;
	}
    ...
    public HigressOpenAiApi.QwenOpenAiCompatibleSearchOptions getSearchOptions() {
        return searchOptions;
    }

    public void setSearchOptions(HigressOpenAiApi.QwenOpenAiCompatibleSearchOptions searchOptions) {
	...
	@Override
	public HigressOpenAiChatOptions copy() {
		return HigressOpenAiChatOptions.fromOptions(this);
	}
	...
	public int hashCode() {
		return Objects.hash(this.model, this.frequencyPenalty, this.logitBias, this.logprobs, this.topLogprobs,
				...
				this.store, this.metadata, this.reasoningEffort, this.webSearchOptions,this.enableThinking,this.enableSearch,this.searchOptions,this.incrementalOutput);
	}
	...
	public boolean equals(Object o) {
		...
		HigressOpenAiChatOptions other = (HigressOpenAiChatOptions) o;
		return Objects.equals(this.model, other.model) && Objects.equals(this.frequencyPenalty, other.frequencyPenalty)
                ...
                && Objects.equals(this.enableSearch, other.enableSearch)
                && Objects.equals(this.searchOptions, other.searchOptions)
	...
	public static class Builder {
		...
		protected HigressOpenAiChatOptions options;

		public Builder() {
			this.options = new HigressOpenAiChatOptions();
		}

		public Builder(HigressOpenAiChatOptions options) {
		...
		public Builder model(HigressOpenAiApi.ChatModel openAiChatModel) {
		...
		public Builder tools(List<HigressOpenAiApi.FunctionTool> tools) {
        ...
        public Builder searchOptions(HigressOpenAiApi.QwenOpenAiCompatibleSearchOptions searchOptions) {
		...
		public HigressOpenAiChatOptions build() {
			return this.options;
		}
