...
public class GraphTest {
    ...
    public void testSimpleGraph() throws Exception {
        ...
        StateGraph<AgentState> workflow = new StateGraph<>(AgentState::new).addNode("agent_3", this::dummyNodeAction).addNode("agent_1", this::dummyNodeAction).addNode("agent_2", this::dummyNodeAction).addEdge(StateGraph.START, "agent_1").addEdge("agent_2", StateGraph.END).addEdge("agent_1", "agent_3").addEdge("agent_3", "agent_2");
    ...
    public void testCorrectionProcessGraph() throws Exception {
        ...
        StateGraph<AgentState> workflow = new StateGraph<>(AgentState::new).addNode("evaluate_result", this::dummyNodeAction).addNode("agent_review", this::dummyNodeAction).addEdge("agent_review", "evaluate_result").addConditionalEdges("evaluate_result", this::dummyCondition, CollectionsUtils.mapOf("OK", StateGraph.END, "ERROR", "agent_review", "UNKNOWN", StateGraph.END)).addEdge(StateGraph.START, "evaluate_result");
    ...
    public void GenerateAgentExecutorGraph() throws Exception {
        StateGraph<AgentState> workflow = new StateGraph<>(AgentState::new).addNode("agent", this::dummyNodeAction).addNode("action", this::dummyNodeAction).addEdge(StateGraph.START, "agent").addConditionalEdges("agent", this::dummyCondition, CollectionsUtils.mapOf("continue", "action", "end", StateGraph.END)).addEdge("action", "agent");
    ...
    public void GenerateImageToDiagramGraph() throws Exception {
        StateGraph<AgentState> workflow = new StateGraph<>(AgentState::new).addNode("agent_describer", this::dummyNodeAction).addNode("agent_sequence_plantuml", this::dummyNodeAction).addNode("agent_generic_plantuml", this::dummyNodeAction).addConditionalEdges("agent_describer", this::dummyCondition, CollectionsUtils.mapOf("sequence", "agent_sequence_plantuml", "generic", "agent_generic_plantuml")).addNode("evaluate_result", this::dummyNodeAction).addEdge("agent_sequence_plantuml", "evaluate_result").addEdge("agent_generic_plantuml", "evaluate_result").addEdge(StateGraph.START, "agent_describer").addEdge("evaluate_result", StateGraph.END);
