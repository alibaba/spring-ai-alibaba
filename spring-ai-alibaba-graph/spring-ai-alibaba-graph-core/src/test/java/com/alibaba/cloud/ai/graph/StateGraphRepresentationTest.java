...
//
// StateGraph workflow = new StateGraph(AgentState::new).addNode("agent_3",
// this::dummyNodeAction)
...
// StateGraph<AgentState> workflow = new StateGraph<>(AgentState::new).addNode("agent",
// this::dummyNodeAction)
// .addNode("action", this::dummyNodeAction)
// .addEdge(START, "agent")
// .addConditionalEdges("agent", this::dummyCondition, mapOf("continue", "action", "end",
// END))
...
// %% condition1:::condition1 -.->|sequence|
// agent_sequence_plantuml:::agent_sequence_plantuml
// agent_describer:::agent_describer -.->|sequence|
// agent_sequence_plantuml:::agent_sequence_plantuml
// %% condition1:::condition1 -.->|generic|
// agent_generic_plantuml:::agent_generic_plantuml
// agent_describer:::agent_describer -.->|generic|
// agent_generic_plantuml:::agent_generic_plantuml
...
// .addEdge("C", END);
//
// var result = workflow.getGraph(GraphRepresentation.Type.PLANTUML,
// "testWithParallelBranch");
//
// assertEquals("""
...
// """, result.content());
//
// result = workflow.getGraph(GraphRepresentation.Type.MERMAID, "testWithParallelBranch",
// false);
//
// assertEquals("""
// ---
...
// .addEdge("C", END);
//
// var result = workflow.compile().getGraph(GraphRepresentation.Type.PLANTUML,
// "testWithParallelBranchOnStart");
//
// assertEquals("""
...
// """, result.content());
//
// result = workflow.getGraph(GraphRepresentation.Type.MERMAID,
// "testWithParallelBranchOnStart", false);
// System.out.println(result.content());
// assertEquals("""
// ---
// title: testWithParallelBranchOnStart
