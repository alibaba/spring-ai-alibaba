...
public class StateGraphMemorySaverTest {
    ...
    public void testCheckpointInitialState() throws Exception {
        ...
        var compileConfig = CompileConfig.builder().saverConfig(SaverConfig.builder()
    ...
    public void testViewAndUpdatePastGraphState() throws Exception {
        ...
        results.forEach( r -> log.info( "{}: Node: {} - {}", r.getClass().getSimpleName(), r.node(), r.state().value("messages").get() ) );
