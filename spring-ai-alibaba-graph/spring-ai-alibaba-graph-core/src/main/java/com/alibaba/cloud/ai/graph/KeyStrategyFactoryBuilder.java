...
/**
 * Builder for creating and managing key strategies for graph node outputs.
 * Provides a fluent API for configuring strategies with sensible defaults.
 * <p>
 * This builder allows you to define how keys should be handled when storing
 * or retrieving values in the graph's state. You can set specific strategies
 * for individual keys, use pattern matching, or apply default behaviors.
 * </p>
 *
 * @author disaster
 * @since 1.0.0.1
