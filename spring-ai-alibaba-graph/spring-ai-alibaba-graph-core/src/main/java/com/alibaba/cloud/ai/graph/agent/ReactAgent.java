...
//
// public ReactAgent(LlmNode llmNode, ToolNode toolNode, int maxIterations, OverAllState
/// state,
...
// }
//
// public ReactAgent(String name, ChatClient chatClient, List<FunctionCallback> tools, int
/// maxIterations)
// throws GraphStateException {
// this.name = name;
// this.llmNode =
/// LlmNode.builder().chatClient(chatClient).messagesKey("messages").build();
...
// }
//
// public ReactAgent(String name, ChatClient chatClient, ToolCallbackResolver resolver,
/// int maxIterations)
// throws GraphStateException {
// this.name = name;
...
// }
//
// public AsyncNodeAction asAsyncNodeAction(String inputKeyFromParent, String
/// outputKeyToParent) {
// if (this.compiledGraph == null) {
// throw new IllegalStateException("ReactAgent not compiled yet");
// }
// return node_async(new SubGraphNodeAdapter(inputKeyFromParent, outputKeyToParent,
/// this.compiledGraph));
// }
//
...
// .addEdge(START, "agent")
// .addConditionalEdges("agent", edge_async(this::think), Map.of("continue", "tool",
/// "end", END))
// .addEdge("tool", "agent");
// }
//
...
// }
// else if (tools != null) {
// return new ReactAgent(name, chatClient, tools, maxIterations, state, compileConfig,
/// shouldContinueFunc);
// }
