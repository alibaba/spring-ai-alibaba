 ...
 * logic that determines transitions along graph edges. They operate on an {@link com.alibaba.cloud.ai.graph.OverAllState}
 * and can optionally interact with a {@link com.alibaba.cloud.ai.graph.RunnableConfig}.
 *
 ...
 * <ul>
 *   <li>{@link com.alibaba.cloud.ai.graph.action.NodeAction}: Represents a synchronous operation
 ...
 *   <li>{@link com.alibaba.cloud.ai.graph.action.NodeActionWithConfig}: Similar to {@code NodeAction},
 *       but also accepts a {@link com.alibaba.cloud.ai.graph.RunnableConfig} parameter, allowing for
 *       more configurable node behavior at runtime.</li>
 *   <li>{@link com.alibaba.cloud.ai.graph.action.EdgeAction}: Defines synchronous conditional logic
 ...
 *   <li>{@link com.alibaba.cloud.ai.graph.action.CommandAction}: Represents a synchronous action that
 *       evaluates the agent state and a {@link com.alibaba.cloud.ai.graph.RunnableConfig} to produce a
 *       {@link com.alibaba.cloud.ai.graph.action.Command}. This command encapsulates both potential state
 *       updates and the next node to transition to, offering a structured way to define node outcomes.</li>
 *   <li>{@link com.alibaba.cloud.ai.graph.action.AsyncNodeAction}: An asynchronous counterpart to
 ...
 *   <li>{@link com.alibaba.cloud.ai.graph.action.AsyncEdgeAction}: The asynchronous version of
