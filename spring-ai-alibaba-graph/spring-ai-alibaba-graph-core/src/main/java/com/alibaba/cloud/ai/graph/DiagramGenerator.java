...
public abstract class DiagramGenerator {
	 ...
	 */
	public final  String generate( StateGraph.Nodes nodes,  StateGraph.Edges edges, String title, boolean printConditionalEdge ) {
	 ...
	 */
	private  void edgeCondition(Context ctx,
