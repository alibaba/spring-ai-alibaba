...
//
// String planningPrompt = "Your are a task planner, please analyze the task and plan the
/// steps.";
//
...
// ReactAgent planningAgent = new ReactAgent("planningAgent", planningClient, resolver,
/// 10);
...
// .addNode("step_executing_agent", stepAgent.asAsyncNodeAction("step_prompt",
/// "step_output"))
//
...
/// compiledGraph.getGraph(GraphRepresentation.Type.PLANTUML);
// System.out.println("\n\n");
