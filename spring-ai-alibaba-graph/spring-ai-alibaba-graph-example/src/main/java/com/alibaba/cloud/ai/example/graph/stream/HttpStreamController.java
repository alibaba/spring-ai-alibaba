...
public class HttpStreamController {
    ...
    public void init() throws GraphStateException {
        ...
        OverAllState state = new OverAllState()
                ...
                .registerKeyAndStrategy("count", (oldValue, newValue) ->
        ...
        StateGraph workflow = new StateGraph()
                ...
                .addNode("generateResponse", node_async(s -> {
                    ...
                    return Map.of(
                            "messages", "Response generated (processed " + count + " items)",
                            "result", "Success"
                    );
                }))
        ...
        // 编译工作流
        this.compiledGraph = workflow.compile(state);
    }
    ...
    public Flux<ServerSentEvent<String>> stream(HttpServletRequest request, @RequestBody Map<String, Object> inputData) throws Exception {
        ...
        generator.forEachAsync(output -> {
            try {
                ...
                String jsonString = JSON.toJSONString(state.data());
                sink.tryEmitNext(ServerSentEvent.builder(jsonString).build());
            } catch (Exception e) {
