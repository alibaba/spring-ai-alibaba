...
public class HumanNodeController {
	...
	public HumanNodeController(ChatModel chatModel) {
	...
	@GetMapping("/simple/resume-to-next-step")
	...
	@GetMapping("/simple/react-resume")
	public String reactResume() {
		Map<String, Object> data = Map.of("input", "请帮我查询最近的新闻");
