...
import com.alibaba.cloud.ai.graph.practice.intelligent_outbound_call.node.*;
	...
	public class GraphBuilder {
		...
		public StateGraph<State> build() throws GraphStateException {
			...
			return new StateGraph<>(State.SCHEMA, stateSerializer).addEdge(START, "welcome")
				...
				.addEdge("welcome", "human01")// 下一个节点
				.addNode("human01", node_async(new HumenNode01()))
				.addEdge("human01", "robot01")// 下一个节点
				.addNode("robot01", node_async(new AIRobotNode01()))
				.addEdge("robot01", "human02")// 下一个节点
				.addNode("human02", node_async(new HumenNode02()))
				.addEdge("human02", "robot02")// 下一个节点
				.addNode("robot02", node_async(new AIRobotNode02()))
				.addEdge("robot02", "agent")// 下一个节点
