...
public class WelcomeNode implements NodeAction<NodeState> {
	...
	// 可以通过前端映射
	private String template = "您好！我是您的保险助手popo。无论您是在寻找保障、规划未来，还是需要专业的保险建议，我都在这里为您提供帮助。请告诉我您的保险需求，让我们开始吧！\n";
	...
	public Map<String, Object> apply(NodeState agentState) {
		...
		return Map.of(NodeState.AGENT_OUTCOME, new IsExecutor.Outcome(null, finish));
	}
