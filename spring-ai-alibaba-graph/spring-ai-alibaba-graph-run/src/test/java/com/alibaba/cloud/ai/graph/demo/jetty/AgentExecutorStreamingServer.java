...
public class AgentExecutorStreamingServer {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * node_async(AgentExecutor.this::callAgent) ) .addNode( "action",
		 * AgentExecutor.this::executeTools ) .addConditionalEdges( "agent",
		 * edge_async(AgentExecutor.this::shouldContinue), Map.of("continue", "action",
		 * "end", END) ) .addEdge("action", "agent") ; }
		 */

		// 打印工作流内容，非json格式
		GraphRepresentation plantUml = graph.getGraph(GraphRepresentation.Type.MERMAID, "Adaptive RAG");
