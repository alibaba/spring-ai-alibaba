...
public class LLMNodeData extends NodeData {
    ...
    public static final Variable DEFAULT_OUTPUT_SCHEMA =
            new Variable("text", VariableType.STRING.value());
    ...
    public static class Message {
        ...
        public String toString() {
            ...
            return String.format("new Message(\"%s\", \"%s\")",
    ...
    public static class Advisor {
        ...
        @Override
        public String toString() {
            return String.format("new Advisor(\"%s\", \"%s\")",
    ...
    public static class ToolCallback {
        ...
        @Override
        public String toString() {
            return String.format("new ToolCallback(\"%s\", %s)",
                    name == null ? "" : name.replace("\"", "\\\""),
