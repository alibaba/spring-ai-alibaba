        ...
        DIFY(new DialectConverter<>() {
            ...
            public HttpNodeData parse(Map<String, Object> data) {
                ...
                List<VariableSelector> inputs = Optional
                        ...
                        .map(list -> Collections.singletonList(
                ...
                if (data.containsKey("auth")) {
                    ...
                    if ("BASIC".equals(type)) {
                        auth = AuthConfig.basic(
                                (String) am.get("username"),
                                (String) am.get("password"));
                ...
                long maxRetryInterval = rcMap != null && rcMap.get("max_retry_interval") != null
                        ? ((Number) rcMap.get("max_retry_interval")).longValue()
                        : 1000L;
                boolean enable = rcMap != null && rcMap.get("enable") != null
                        ? (Boolean) rcMap.get("enable")
                        : true;
