...
public class GenerateJsonSchemaTest {
	...
	public void generateWithVictools() {
		...
		SchemaGeneratorConfig config = configBuilder.with(MAP_VALUES_AS_ADDITIONAL_PROPERTIES, STRICT_TYPE_INFO)
			.build();
...
class GPTJsonSchemaGenerator {
	...
	public static void main(String[] args) {
		...
		inputMap.put("preferences", Map.of("notifications", "email", "theme", "dark"));
...
class ClaudeJsonSchemaGenerator {
	...
	public static void main(String[] args) {
		// Example usage
		Map<String, Object> testMap = Map.of("name", "John Doe", "age", 30, "isStudent", false, "grades",
				List.of(85, 90, 78), "address", Map.of("street", "123 Main St", "city", "Anytown"));
...
class CopilotJsonSchemaGenerator {
	...
	public static void main(String[] args) {
		// Sample input map
		Map<String, Object> inputMap = Map.of("name", "John Doe", "age", 30, "address",
				Map.of("street", "123 Main St", "city", "Anytown"));
