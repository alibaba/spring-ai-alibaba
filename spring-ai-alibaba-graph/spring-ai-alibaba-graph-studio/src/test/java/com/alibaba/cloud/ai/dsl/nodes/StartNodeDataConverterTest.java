...
public class StartNodeDataConverterTest {
    ...
    public void testDumpDifyDSL(){
        StartNodeData startNodeData = new StartNodeData()
                .setStartInputs(List.of(
                        new StartNodeData.StartInput()
                                .setVariable("user_query")
                                .setLabel("user_query")
                                .setType("paragraph")
                                .setMaxLength(200)
                                .setRequired(true),
    ...
    public void testDumpCustomDSL(){
        ...
        Map<String, Object> customStartNodeDataMap = nodeDataConverter.dumpMapData(startNodeData, DSLDialectType.CUSTOM);
        assertNotNull(customStartNodeDataMap);
        List<Map<String, Object>> startInputMaps = (List<Map<String, Object>>)customStartNodeDataMap.get("startInputs");
