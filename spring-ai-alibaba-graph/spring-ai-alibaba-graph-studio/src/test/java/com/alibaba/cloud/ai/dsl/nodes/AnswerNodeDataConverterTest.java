...
public class AnswerNodeDataConverterTest {
    ...
    /**
     * dify dsl test case:
        answer: '答案是：{{#1733282983968.output#}}'
        desc: ''
        selected: false
        title: Answer
        type: answer
    ...
    public void testDumpDifyDSL(){
        AnswerNodeData answerNodeData = new AnswerNodeData(
                List.of(new VariableSelector("1733282983968", "output")),
    ...
    public void testDumpCustomDSL(){
        AnswerNodeData answerNodeData = new AnswerNodeData(
                List.of(new VariableSelector("llm", "text")),
                List.of(new Variable("answer", VariableType.STRING.value()))
