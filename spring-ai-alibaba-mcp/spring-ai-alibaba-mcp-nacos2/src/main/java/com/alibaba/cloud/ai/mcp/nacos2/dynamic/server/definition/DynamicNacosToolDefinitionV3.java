...
package com.alibaba.cloud.ai.mcp.nacos2.dynamic.server.definition;
...
public class DynamicNacosToolDefinitionV3 implements ToolDefinition {
	...
	public static DynamicNacosToolDefinitionV3.Builder builder() {
		return new DynamicNacosToolDefinitionV3.Builder();
	}
	...
	public static final class Builder {
		...
		public DynamicNacosToolDefinitionV3.Builder name(final String name) {
			this.name = name;
			return this;
		}
		...
		public DynamicNacosToolDefinitionV3.Builder version(final String version) {
			this.version = version;
			return this;
		}

		public DynamicNacosToolDefinitionV3.Builder remoteServerConfig(final Object remoteServerConfig) {
			this.remoteServerConfig = remoteServerConfig;
			return this;
		}

		public DynamicNacosToolDefinitionV3.Builder localServerConfig(final Object localServerConfig) {
			this.localServerConfig = localServerConfig;
			return this;
		}

		public DynamicNacosToolDefinitionV3.Builder credentials(final Object credentials) {
			this.credentials = credentials;
			return this;
		}

		public DynamicNacosToolDefinitionV3.Builder enabled(final Boolean enabled) {
			this.enabled = enabled;
			return this;
		}

		public DynamicNacosToolDefinitionV3.Builder protocol(final String protocol) {
			this.protocol = protocol;
			return this;
		}

		public DynamicNacosToolDefinitionV3.Builder inputSchema(final Object inputSchema) {
			this.inputSchema = inputSchema;
			return this;
		}
