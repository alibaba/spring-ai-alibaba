...
public class DynamicToolsInitializer {
    ...
    public DynamicToolsInitializer(NacosMcpOperationService nacosMcpOperationService,
            NacosMcpDynamicProperties nacosMcpDynamicProperties) {
        ...
        for (String serverName : serverNames) {
            try {
                ...
                boolean isProtocolSupported =
                        StringUtils.equals(mcpServerDetailInfo.getProtocol(), "http") || StringUtils.equals(
                                mcpServerDetailInfo.getProtocol(), "https");
