...
(3, 'product_db', 'h2', null, null, 'product_db', 'root', 'root', 'jdbc:h2:mem:nl2sql_database;DB_CLOSE_DELAY=-1;DATABASE_TO_LOWER=true;MODE=MySQL;DB_CLOSE_ON_EXIT=FALSE', 'active', 'success', 'h2测试数据库，包含核心业务数据', 2100246635, NOW(), NOW());
