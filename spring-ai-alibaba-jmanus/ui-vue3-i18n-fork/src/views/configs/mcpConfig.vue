            ...
            <div class="connection-type-options">
              ...
              <div class="connection-type-option">
                ...
                <label for="mcp-connection-type-sse" class="radio-label">
                  ...
                  <span class="connection-type-desc"
                    >通过http server等提供的，目前网络上比较少见</span
                  >
                </label>
              </div>
            </div>
          ...
          <ol>
            <li>
              ...
              <ul class="indented-list">
                <li>
                  <strong>本地(STDIO)</strong>：可以在<a
                    href="https://mcp.so"
                    target="_blank"
                    rel="noopener"
                    >mcp.so</a
                  >上找到，需要你有Node.js环境并理解你要配置的json里面的每一个项，做对应调整比如配置ak
                </li>
                <li>
                  <strong>远程服务(SSE)</strong>：<a
                    ...
                    rel="noopener"
                    >mcp.higress.ai/</a
                  >上可以找到，有SSE和STREAMING两种，目前SSE协议更完备一些
                </li>
              </ul>
            </li>
            ...
            <li>
              然后需要在Agent配置里面，新建一个agent，然后增加指定你刚才添加的mcp
              tools，这样可以极大减少冲突，增强tools被agent选择的准确性
            </li>
          </ol>
        </div>
      </div>
