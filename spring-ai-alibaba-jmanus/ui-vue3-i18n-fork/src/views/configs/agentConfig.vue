  ...
  <div class="config-panel">
    ...
    <div class="agent-layout">
      ...
      <div class="agent-detail" v-if="selectedAgent">
        ...
        <div class="form-item">
          ...
          <input type="text" v-model="selectedAgent.name" placeholder="输入Agent名称" required />
        </div>
        ...
        <div class="tools-section">
          ...
          <div class="assigned-tools">
            ...
            <div class="tools-grid">
              ...
              <div
                v-if="!selectedAgent.availableTools || selectedAgent.availableTools.length === 0"
                class="no-tools"
              >
    ...
    <Modal v-model="showModal" title="新建Agent" @confirm="handleAddAgent">
      <div class="modal-form">
        <div class="form-item">
          <label>Agent名称 <span class="required">*</span></label>
          <input type="text" v-model="newAgent.name" placeholder="输入Agent名称" required />
        </div>
        <div class="form-item">
          <label>描述 <span class="required">*</span></label>
          <textarea
    ...
    <Modal v-model="showDeleteModal" title="删除确认">
      <div class="delete-confirm">
        ...
        <p>
          确定要删除 <strong>{{ selectedAgent?.name }}</strong> 吗？
        </p>
...
const unassignedTools = computed(() => {
  if (
    ...
    !Array.isArray(selectedAgent.value.availableTools)
  ) {
...
const selectAgent = async (agent: Agent) => {
  ...
  try {
    ...
    selectedAgent.value = {
      ...detailedAgent,
      availableTools: Array.isArray(detailedAgent.availableTools)
        ? detailedAgent.availableTools
        : [],
    }
  } catch (err: any) {
