...
<template>
  <div class="home-page">
    <div style="float: right">
      <a-button @click="changeLanguage('zh')">中</a-button>
      <a-button @click="changeLanguage('en')">En</a-button>
    </div>
    <!-- 简化的 Hello World 主页 -->
    <div class="welcome-container">
      ...
      <header class="header">
        <div class="logo-container">
          ...
          <span class="tagline">Java AI {{ $t('home.agent') }}</span>
        </div>
      </header>
      ...
      <main class="main-content">
        <div class="conversation-container">
          ...
          <div class="welcome-section">
            <h2 class="welcome-title">{{ $t('home.welcome') }} JTaskPoilot！</h2>
            <p class="welcome-subtitle">{{ $t('home.introduce') }}</p>
          </div>
...
const examples = [
  {
    title: 'home.examples.titles.stockPrice',
    description: 'home.examples.descriptions.stockPrice',
    icon: 'carbon:chart-line-data',
    prompt: '用浏览器基于百度，查询今天阿里巴巴的股价，并返回最新股价',
  },
  {
    title: 'home.examples.titles.novelGeneration',
    description: 'home.examples.descriptions.novelGeneration',
    icon: 'carbon:book',
    prompt:
      '请帮我写一个关于机器人取代人类的小说。20000字。 使用TEXT_FILE_AGENT ，先生成提纲，然后，完善和丰满整个提纲的内容为一篇通顺的小说，最后再全局通顺一下语法',
  },
  {
    title: 'home.examples.titles.weatherForecast',
    description: 'home.examples.descriptions.weatherForecast',
