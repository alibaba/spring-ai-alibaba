...
public class SubplanToolService implements ISubplanToolService {
    ...
    @Override
    public Map<String, PlanningFactory.ToolCallBackContext> createSubplanToolCallbacks(
            String planId, String rootPlanId, String expectedReturnInfo) {
        ...
        try {
            ...
            for (SubplanToolDef subplanTool : subplanTools) {
                try {
                    ...
                    logger.info("Successfully registered subplan tool: {} -> {}", 
    ...
    public SubplanToolDef updateSubplanTool(SubplanToolDef toolDef) {
        ...
        logger.info("Successfully updated subplan tool: {} with ID: {}", updatedTool.getToolName(), updatedTool.getId());
    ...
    private String convertParametersToSchema(SubplanToolDef subplanTool) {
        try {
            ...
            for (com.alibaba.cloud.ai.example.manus.subplan.model.po.SubplanParamDef param : subplanTool.getInputSchema()) {
