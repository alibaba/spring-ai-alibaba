...
/**
 * Service implementation for managing plan relationships
 * Provides functionality to record and query parent-child relationships between plans
 */
@Service
public class PlanRelationshipService implements IPlanRelationshipService {
    ...
    public void recordPlanRelationship(String parentPlanId, String childPlanId, String rootPlanId, 
        ...
        try {
            PlanRelationship relationship = new PlanRelationship(
                parentPlanId, childPlanId, rootPlanId, planTemplateId, relationshipType
            );
            
            PlanRelationship savedRelationship = planRelationshipRepository.save(relationship);
            logger.info("Recorded plan relationship: parent={}, child={}, root={}, type={}", 
                       parentPlanId, childPlanId, rootPlanId, relationshipType);
            
        } catch (Exception e) {
            logger.error("Failed to record plan relationship: parent={}, child={}, root={}", 
                        parentPlanId, childPlanId, rootPlanId, e);
