...
public class CronServiceImpl implements CronService {
    ...
    public CronConfig createCronTask(CronConfig config) {
        try {
            ...
            log.info("Successfully created new cron task: {}", config.getPlanDesc());
            return entity.mapToCronConfig();
        } catch (Exception e) {
            log.warn("Exception occurred during cron task creation: {}, error message: {}", config.getPlanDesc(),
                    e.getMessage());
            throw e;
        }
    }
    ...
    private void validateCronExpression(String cronExpression) {
        ...
        try {
            ...
            log.debug("Cron expression validation passed: {}", cronExpression);
        } catch (IllegalArgumentException e) {
            log.error("Invalid cron expression: {}, error: {}", cronExpression, e.getMessage());
