...
/**
 * Standalone class for storing action tool information.
 * Records details about tools used during action execution phases.
 * 
 * This class was previously an inner class of ThinkActRecord and has been
 * extracted to provide better reusability and cleaner architecture.
 * 
