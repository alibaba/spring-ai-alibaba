...
public class DatabaseRequestVO {
    ...
    /**
     * Database operation type. E.g. execute_sql, get_table_name, get_table_desc, get_table_index, get_table_lock, get_db_health_running, get_db_health_index_usage, get_chinese_initials
     */
