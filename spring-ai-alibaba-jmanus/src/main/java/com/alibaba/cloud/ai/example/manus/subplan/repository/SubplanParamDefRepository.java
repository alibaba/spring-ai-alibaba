 ...
 */
package com.alibaba.cloud.ai.example.manus.subplan.repository;

import com.alibaba.cloud.ai.example.manus.subplan.model.po.SubplanParamDef;
...
public interface SubplanParamDefRepository extends JpaRepository<SubplanParamDef, Long> {
    ...
    List<SubplanParamDef> findByToolDefIdAndTypeIn(@Param("toolDefId") Long toolDefId, @Param("types") List<String> types);
}
