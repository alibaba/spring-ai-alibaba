...
// */
// package com.alibaba.cloud.ai.manus.subplan;

// import com.alibaba.cloud.ai.manus.planning.PlanningFactory;
// import com.alibaba.cloud.ai.manus.planning.coordinator.PlanIdDispatcher;
// import com.alibaba.cloud.ai.manus.planning.coordinator.PlanningCoordinator;
// import com.alibaba.cloud.ai.manus.planning.model.vo.ExecutionContext;
// import com.alibaba.cloud.ai.manus.planning.model.vo.ExecutionStep;
// import com.alibaba.cloud.ai.manus.planning.model.vo.mapreduce.MapReduceExecutionPlan;
// import com.alibaba.cloud.ai.manus.dynamic.prompt.service.PromptService;
...
// * 1. This
// * is a core workflow template that should not be externally modified 2. Using a
// * local
// * template improves performance by avoiding service calls 3. It ensures
// * consistency
// * and stability of the core summarization workflow 4. The template is fixed and
// * does
...
// "planType": "advanced",
// "planId": "<planId>",
// "title": "Intelligent content summarization for large files, with final merged file
// name output in summary",
// "steps": [
// {
// "type": "mapreduce",
// "dataPreparedSteps": [
// {
// "stepRequirement": "[MAPREDUCE_DATA_PREPARE_AGENT] Use map_reduce_tool to split content
// of file <fileName>"
// }
// ],
// "mapSteps": [
// {
// "stepRequirement": "[MAPREDUCE_MAP_TASK_AGENT] Analyze file, find key information
// related to ```<queryKey>```, information should be comprehensive, including all data,
// facts and opinions, comprehensive information without omission. Output format
// specification: ``` <outputFormatSpecification>```. File format requirement: Markdown."
// }
// ],
// "reduceSteps": [
// {
// "stepRequirement": "[MAPREDUCE_REDUCE_TASK_AGENT] Merge the information from this chunk
// into file, while maintaining information integrity, merge all content and remove
// results with no content found. Output format specification:
// <outputFormatSpecification>. File format requirement: Markdown."
// }
// ],
// "postProcessSteps": [
// {
// "stepRequirement": "[MAPREDUCE_FIN_AGENT] After export completion, read the exported
// results and output all exported content completely. Output format specification:
// <outputFormatSpecification>. File format requirement: Markdown."
// }
// ]
// }
...
// * data
// * should be stored (default is an excel
// * table), the table header of this file is the
// * specification description
// * @return Future of summarization result
// */
// public CompletableFuture<String> executeSummaryWorkflow(String parentPlanId, String
...
// MapReduceExecutionPlan executionPlan = buildSummaryExecutionPlan(parentPlanId,
// fileName, content, queryKey,
...
// * parameters
// */
// private MapReduceExecutionPlan buildSummaryExecutionPlan(String parentPlanId, String
// fileName, String content,
...
// MapReduceExecutionPlan plan = objectMapper.readValue(planJson,
// MapReduceExecutionPlan.class);
...
// throw new RuntimeException("Failed to build MapReduce summary execution plan: " +
// e.getMessage(), e);
// }
// }
...
// planningFactory.createPlanningCoordinator(subPlanId);
...
// logger.info("MapReduce summary plan executed successfully, sub-plan ID: {}, parent plan
// ID: {}",
...
// return "getContent executed successfully, execution result log: " +
// lastStep.getResult();
// }
// catch (Exception e) {
