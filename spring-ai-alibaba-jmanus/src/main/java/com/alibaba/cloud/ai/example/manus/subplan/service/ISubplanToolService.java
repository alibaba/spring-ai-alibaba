...
public interface ISubplanToolService {
    ...
    /**
     * Create tool callback context map for subplan tools
     * This integrates with the existing PlanningFactory tool registry system
     * 
     ...
     */
    Map<String, PlanningFactory.ToolCallBackContext> createSubplanToolCallbacks(
