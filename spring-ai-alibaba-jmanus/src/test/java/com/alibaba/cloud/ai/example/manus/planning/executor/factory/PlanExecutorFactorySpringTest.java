...
/**
 * Spring integration test for PlanExecutorFactory
 * Tests the factory's ability to create appropriate executors based on plan type
 */
...
class PlanExecutorFactorySpringTest {
    ...
    void setUp() {
        ...
        planExecutorFactory = new PlanExecutorFactory(agents, llmService, agentService, recorder);
    ...
    void testCreateSimpleExecutor() {
        try {
            ...
            Assertions.assertTrue(executor instanceof PlanExecutor, 
                    "Should create PlanExecutor for simple plan type");
    ...
    void testCreateExecutorByExplicitType() {
        try {
            ...
            PlanExecutorInterface simpleExecutor = planExecutorFactory.createExecutorByType("simple", "test-explicit-001");
            ...
            PlanExecutorInterface advancedExecutor = planExecutorFactory.createExecutorByType("advanced", "test-explicit-002");
            ...
            PlanExecutorInterface unknownExecutor = planExecutorFactory.createExecutorByType("unknown", "test-explicit-003");
    ...
    void testSupportedPlanTypes() {
        try {
            ...
            Assertions.assertTrue(List.of(supportedTypes).contains("simple"), 
                    "Should support simple plan type");
            Assertions.assertTrue(List.of(supportedTypes).contains("advanced"), 
                    "Should support advanced plan type");
            
            log.info("Step 2: Test plan type support checking");
            Assertions.assertTrue(planExecutorFactory.isPlanTypeSupported("simple"), 
                    "Should support simple type");
            Assertions.assertTrue(planExecutorFactory.isPlanTypeSupported("advanced"), 
                    "Should support advanced type");
            Assertions.assertTrue(planExecutorFactory.isPlanTypeSupported("SIMPLE"), 
            ...
            Assertions.assertFalse(planExecutorFactory.isPlanTypeSupported(null), 
                    "Should not support null type");
