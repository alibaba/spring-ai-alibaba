...
/**
 * Spring integration test class for BrowserUseTool using real Spring context to test BrowserUseTool functionality
 */
...
class BrowserUseToolSpringTest {
    ...
    void testHelloWorldSearch() {
        try {
            ...
            Assertions.assertEquals("Navigated to https://www.baidu.com", navigateResult.getOutput(), "Failed to navigate to Baidu");
            ...
            for (int i = 0; i < elementLines.length; i++) {
                if (elementLines[i].contains("name=\"wd\"") || elementLines[i].contains("id=\"kw\"")) { // Baidu search box characteristics
                    searchInputIndex = i;
                    break;
                }
            }
            ...
            Assertions.assertTrue(inputResult.getOutput().contains("Hello World"), "Failed to input text in search box");
            ...
            Assertions.assertTrue(clickResult.getOutput().contains("Clicked"), "Failed to click search button: " + clickResult.getOutput());
            ...
            Assertions.assertTrue(searchResults.contains("Hello World"), "Did not find 'Hello World' in search results");
    ...
    void testGetElementPositionAndMoveToClick() {
        try {
            ...
            // Step 8: Use GetElementPositionByNameAction to find and click Baidu Baike link
            ...
            if (!baikePositionsList.isEmpty()) {
                ...
                if (targetPosition != null) {
                    ...
                    Assertions.assertTrue(baikeClickResult.getOutput().contains("Clicked"), "Failed to click '百度百科' link");
    ...
    void testGitHubSearch() {
        ...
        Assertions.assertEquals("Navigated to https://github.com", navigateResult.getOutput(), "Failed to navigate to GitHub");
    ...
    void testNacosPageLink() {
        ...
        Assertions.assertEquals("Navigated to https://nacos.io", navigateResult.getOutput(), "Failed to navigate to Nacos");
    ...
    void testCsdnLogin() {
        try {
            ...
            if (loginButtonIndex == -1) {
                ...
                // Note: We won't actually click the login button to avoid actually logging in
