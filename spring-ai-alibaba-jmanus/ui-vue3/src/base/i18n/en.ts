...
const words: I18nType = {
  ...
  configDisplayNames: {
      maxSteps: 'Max agent execution steps',
      ...
      headlessBrowser: 'Whether to use headless browser mode',
      browserDebug: 'Browser debug mode',
      autoOpenBrowser: 'Automatically open browser on startup',
      consoleInteractive: 'Enable console interactive mode',
      systemName: 'System name',
      language: 'Default language',
      maxThreads: 'Maximum number of threads',
    },
  groupDisplayNames: {
      manus: 'Agent Settings',
