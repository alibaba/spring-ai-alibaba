...
const words: I18nType = {
  ...
  config: {
    ...
    agentConfig: {
      ...
      modelChoose: 'Model Selection',
      controlledByPlan: 'Controlled by Plan (based on Model configuration, the plan controls model invocation)',
      modelName: 'Model Name',
      modelNamePlaceholder: 'Enter model name (leave empty to use default model)',
