...
public class PlanIdDispatcher {
    ...
    /**
     * 将planTemplateId转换为planId
     * 由于一个planTemplate可以生成多个plan，所以每次生成唯一的planId
     * 
    ...
    /**
     * 将planId转换为planTemplateId
     * 如果输入已经是planTemplateId格式则直接返回
     * 
     * @param planId 计划ID
    ...
    /**
     * 根据现有ID生成对应的另一种类型ID
     * 如果是planId，则转换为planTemplateId
     * 如果是planTemplateId，则转换为planId
     * 
     * @param id 现有ID
     * @return 转换后的ID
     */
