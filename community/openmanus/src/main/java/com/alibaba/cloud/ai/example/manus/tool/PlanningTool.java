...
public class PlanningTool implements Function<String, ToolExecuteResult> {
    ...
    public  FunctionToolCallback getFunctionToolCallback() {
        return FunctionToolCallback.builder(name, new PlanningTool())
    ...
    public ToolExecuteResult run(String toolInput) {
        try {
            ...
            List<String> steps = JSON.parseObject(JSON.toJSONString(input.get("steps")), new TypeReference<List<String>>() {});
            Integer stepIndex = (Integer) input.get("step_index");
            String stepStatus = (String) input.get("step_status");
            String stepNotes = (String) input.get("step_notes");
    ...
    //     out.append("Plan: ").append(plan.getTitle()).append(" (ID: ").append(plan.getPlanId()).append(")\n");
    ...
    //         out.append(i).append(". ").append(symbol).append(" ").append(steps.get(i)).append("\n");
