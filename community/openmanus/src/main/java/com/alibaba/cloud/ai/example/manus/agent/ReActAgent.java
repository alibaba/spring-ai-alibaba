...
/**
 * ReAct（Reasoning + Acting）模式的智能体基类
 * 实现了思考(Reasoning)和行动(Acting)交替执行的智能体模式
 */
public abstract class ReActAgent extends BaseAgent {
     ...
     * 
     * 示例实现：
     * - ToolCallAgent：执行选定的工具调用
     * - BrowserAgent：执行浏览器操作
     * 
     * @return 行动执行的结果描述
     */
     ...
     *    - 任务目标
     *    - 思考方向指导
     * 3. 可由子类进行扩展，添加特定的思考模式
     * 
     * 子类扩展参考：
     * - ToolCallAgent：添加工具选择相关的思考提示
     * - BrowserAgent：添加网页操作相关的思考提示
     * 
