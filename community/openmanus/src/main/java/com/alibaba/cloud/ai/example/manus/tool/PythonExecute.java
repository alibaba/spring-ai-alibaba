...
public class PythonExecute implements ToolCallBiFunctionDef {
    ...
    public String getCurrentToolStateString() {
        return String.format("""
                ...
                """,
                arm64 ? "ARM64" : "x86_64",
                lastCode.isEmpty() ? "No code executed yet" : 
                    String.format("Last executed:\n%s", lastCode),
                hasError ? "❌ Failed with errors" : "✅ Success",
                hasError ? lastError : "No errors",
    ...
    public ToolExecuteResult run(String toolInput) {
        ...
        try {
            ...
            if (result.contains("SyntaxError") || result.contains("IndentationError") || 
                result.contains("NameError") || result.contains("TypeError") ||
                result.contains("ValueError") || result.contains("ImportError")) {
                this.hasError = true;
