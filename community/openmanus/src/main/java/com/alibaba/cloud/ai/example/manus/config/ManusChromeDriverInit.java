...
// // 改为public以供ChromeDriverService使用
// public String getChromedriverPath(String resourcePath) throws URISyntaxException {

// URL resource =
// OpenManusSpringBootApplication.class.getClassLoader().getResource(resourcePath);
// if (resource == null) {
