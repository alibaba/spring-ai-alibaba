...
public class PlanCreator {
	...
	public PlanCreator(List<BaseAgent> agents, LlmService llmService, PlanningTool planningTool, PlanExecutionRecorder recorder) {
        this.agents = agents;
    ...
    public void createPlan(ExecutionContext context) {
        ...
        String planId = context.getPlan().getPlanId();
