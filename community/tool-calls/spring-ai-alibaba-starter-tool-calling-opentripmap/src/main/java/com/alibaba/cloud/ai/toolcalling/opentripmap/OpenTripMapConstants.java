...
/**
 * OpenTripMap constants for configuration and API interactions.
 * 
 * @author Makoto
 */
public final class OpenTripMapConstants {

	public static final String CONFIG_PREFIX = TOOL_CALLING_CONFIG_PREFIX + ".opentripmap";

	public static final String API_KEY_ENV = "OPENTRIPMAP_API_KEY";
