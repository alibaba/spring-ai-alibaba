...
public final class SerpApiConstants {

	public static final String CONFIG_PREFIX = TOOL_CALLING_CONFIG_PREFIX + ".serpapi";

	public static final String TOOL_NAME = "serpApiSearch";
