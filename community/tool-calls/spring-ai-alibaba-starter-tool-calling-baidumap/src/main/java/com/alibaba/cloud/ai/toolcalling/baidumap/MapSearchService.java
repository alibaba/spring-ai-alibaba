 ...
 * @author Carbon
 */
public class MapSearchService implements Function<MapSearchService.Request,
        MapSearchService.Response> {
    ...
    public Response apply (Request request) {
        ...
        try {
            ...
            JsonObject cityCodeJson = JsonParser.parseString(addressCityCodeResponse)
                    .getAsJsonObject();
            ...
            if (districtsElement != null && districtsElement.isJsonArray()) {
                ...
                // 获取并处理设施信息
                String facilityJsonStr = mapTools.getFacilityInformation(request.address,
                        request.facilityType);
                JsonElement facilityElement = JsonParser.parseString(facilityJsonStr);
                JsonElement resultsElement = facilityElement.getAsJsonObject()
                        .get("results");
