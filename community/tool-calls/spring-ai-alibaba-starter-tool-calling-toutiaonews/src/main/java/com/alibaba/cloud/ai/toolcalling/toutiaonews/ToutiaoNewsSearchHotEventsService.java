 ...
 * @since 2024/12/18
 */
public class ToutiaoNewsSearchHotEventsService implements Function<ToutiaoNewsSearchHotEventsService.Request, ToutiaoNewsSearchHotEventsService.Response> {

    private static final Logger logger =
			LoggerFactory.getLogger(ToutiaoNewsSearchHotEventsService.class);

    private static final String API_URL = "https://www.toutiao.com/hot-event/hot-board/?origin" +
			"=toutiao_pc";
    ...
    public ToutiaoNewsSearchHotEventsService.Response apply (ToutiaoNewsSearchHotEventsService.Request request) {
        ...
        logger.info("{} hotEvents: {}", this.getClass()
                .getSimpleName(), hotEvents);
    ...
    protected JsonNode fetchDataFromApi () {
        return WEB_CLIENT.get()
                ...
                .onStatus(status -> status.is4xxClientError() || status.is5xxServerError(),
						clientResponse -> Mono.error(new RuntimeException("API call failed with " +
    ...
    protected List<HotEvent> parseHotEvents (JsonNode rootNode) {
        ...
        for (JsonNode itemNode : dataNode) {
            ...
            String title = itemNode.get("Title")
                    .asText();
