...
public final class DuckDuckGoConstants {

	public static final String CONFIG_PREFIX = TOOL_CALLING_CONFIG_PREFIX + ".duckduckgo";

	public static final String TOOL_NAME = "duckDuckGoQueryNews";
