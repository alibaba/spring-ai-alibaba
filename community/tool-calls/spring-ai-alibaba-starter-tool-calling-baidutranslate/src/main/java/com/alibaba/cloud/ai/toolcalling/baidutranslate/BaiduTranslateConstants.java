...
public final class BaiduTranslateConstants {

	public static final String CONFIG_PREFIX = TOOL_CALLING_CONFIG_PREFIX + ".baidu.translate";

	public static final String TOOL_NAME = "baiduTranslate";
