 ...
 * @author 北极星
 */
public class DuckDuckGoQueryNewsService implements Function<DuckDuckGoQueryNewsService.DuckDuckGoQueryNewsRequest, Map<String, Object>> {
    ...
    public Map<String, Object> apply (DuckDuckGoQueryNewsRequest request) {
        try {
            return webClient.method(HttpMethod.GET)
                    .uri(uriBuilder -> uriBuilder.queryParam("secret_api_key",
    ...
    record DuckDuckGoQueryNewsRequest(
            @JsonProperty(required = true, value = "q") @JsonPropertyDescription("The query " +
                    "keyword e.g. spring-ai-alibaba") String q,
