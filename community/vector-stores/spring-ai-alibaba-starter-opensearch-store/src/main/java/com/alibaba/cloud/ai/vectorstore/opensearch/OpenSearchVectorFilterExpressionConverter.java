 ...
 * @author 北极星
 */
public class OpenSearchVectorFilterExpressionConverter extends AbstractFilterExpressionConverter {
    ...
    public OpenSearchVectorFilterExpressionConverter () {
        this.dateFormat = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'Z'");
        this.dateFormat.setTimeZone(TimeZone.getTimeZone(ZoneId.ofOffset("UTC",
    ...
    public void doKey (Filter.Key key, StringBuilder context) {
        ...
        context.append(prefixedIdentifier.trim())
                .append(":");
    }
    ...
    protected void doSingleValue (Object value, StringBuilder context) {
        if (value instanceof Date date) {
            ...
            if (DATE_FORMAT_PATTERN.matcher(text)
                    .matches()) {
                try {
