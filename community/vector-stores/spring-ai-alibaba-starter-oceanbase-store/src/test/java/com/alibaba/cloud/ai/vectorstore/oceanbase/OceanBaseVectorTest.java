...
/**
 * OceanBase vector store test.
 * This class tests adding, searching, and deleting documents in OceanBase.
 */
...
class OceanBaseVectorTest {
    ...
    public ApplicationContextRunner initApplicationContextRunner() {
        return new ApplicationContextRunner()
                ...
                .withPropertyValues(
                        "spring.ai.vectorstore.oceanbase.url=" + getJdbcUrl(),
    ...
    private String getJdbcUrl() {
        return "jdbc:oceanbase://" + oceanBaseContainer.getHost() + ":" +
                oceanBaseContainer.getMappedPort(PORT) + "/" + OCEANBASE_DATABASE;
    }
    ...
    private Class<?> loadDriverClass() {
        try {
            ...
            throw new RuntimeException(
                    "Failed to load driver class: " + OCEANBASE_DRIVER_CLASS, e);
        }
    }
