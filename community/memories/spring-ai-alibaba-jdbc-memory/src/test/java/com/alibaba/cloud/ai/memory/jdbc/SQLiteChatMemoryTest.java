...
// // @Test
// public void sqlite() {
// SQLiteChatMemory chatMemory = new SQLiteChatMemory(null, null,
/// "jdbc:sqlite:spring_ai_alibaba_chat_memory.db");
// String apiKey = System.getenv().getOrDefault("AI_DASHSCOPE_API_KEY", "test-api-key");
// ChatClient chatClient = ChatClient.create(new DashScopeChatModel(new
/// DashScopeApi(apiKey)));
