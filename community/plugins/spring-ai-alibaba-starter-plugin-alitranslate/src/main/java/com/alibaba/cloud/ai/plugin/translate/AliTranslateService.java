 ...
 * @author YunLong
 */
public class AliTranslateService implements Function<TranslateService.Request, TranslateService.Response> {
	...
	public AliTranslateService(AliTranslateProperties properties) {
		...
		this.webClient = WebClient.builder()
			.defaultHeader(AliTranslateProperties.OCP_APIM_SUBSCRIPTION_KEY, properties.getApiKey())
