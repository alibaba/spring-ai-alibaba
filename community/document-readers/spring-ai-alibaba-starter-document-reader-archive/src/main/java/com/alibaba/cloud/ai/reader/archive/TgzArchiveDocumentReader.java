 ...
 * @author aruato
 */
public class TgzArchiveDocumentReader extends AbstractArchiveDocumentReader {
	...
	@Override
	protected ArchiveInputStream createArchiveStream(InputStream in, String charset) throws IOException {
