...
/**
 * A client for interacting with the Gitbook API.
 * This client provides methods to fetch spaces, pages, and their content from Gitbook.
...
public class GitbookClient {
    ...
    /**
     * Creates a new GitbookClient with the specified API token and optional custom API URL.
     *
    ...
    /**
     * Lists all pages in a Gitbook space, including their metadata.
     * This method recursively traverses the page structure to build a flat list
     * of all pages, maintaining their hierarchical relationships in the metadata.
     *
    ...
    private <T> T makeRequest(String url, Class<T> responseType) {
        try {
            ...
            if (response.statusCode() != 200) {
                throw new RuntimeException("Failed to make request to Gitbook API. Status code: " + response.statusCode());
            }
    ...
    /**
     * Recursively extracts page information and builds the page hierarchy.
     * This method processes both document pages and group pages, maintaining
     * the hierarchical structure in the page metadata.
     *
     ...
     */
    private void extractPageInfo(List<GitbookPage> pages, GitbookPage page,
            String prevTitle, String parent) {
