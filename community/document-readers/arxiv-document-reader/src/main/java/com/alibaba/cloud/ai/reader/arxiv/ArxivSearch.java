 ...
 * arXiv数据库搜索的规范
 * 
 * @see <a href="https://arxiv.org/help/api/user-manual#query_details">arXiv API User's Manual: Details of Query Construction</a>
 */
public class ArxivSearch {
    ...
    public ArxivSearch(String query, List<String> idList, Integer maxResults, 
                 ArxivSortCriterion sortBy, ArxivSortOrder sortOrder) {
        this.query = query;
        this.idList = idList;
