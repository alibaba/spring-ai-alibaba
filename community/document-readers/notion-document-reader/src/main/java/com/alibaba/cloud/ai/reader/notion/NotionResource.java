...
/**
 * Notion Resource class
 * Supports accessing Notion pages and databases
 *
 * @author xiadong
 * @since 2024-01-06
 */
public class NotionResource implements Resource {
    ...
    private String getPageContent(String notionToken, String pageId) {
        try {
            ...
            HttpResponse<String> blocksResponse = this.httpClient.send(blocksRequest, HttpResponse.BodyHandlers.ofString());
