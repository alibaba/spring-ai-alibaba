...
/**
 * Test cases for MySQL document reader
 * Note: Requires a running MySQL instance with test data
 *
 * @author brianxiadong
 **/
public class MySQLDocumentReaderTest {
    ...
    void setUp() {
        ...
        mysqlResource = new MySQLResource(
            ...
            Arrays.asList("username", "email"),  // content columns
    ...
    void testInvalidConnection() {
        ...
        MySQLResource invalidResource = new MySQLResource(
            "invalid_host",
            3306,
            "invalid_db",
            "invalid_user",
