...
class DatabaseStoreAllDialectTest {
	...
	void shouldUseMysqlInitializeTableSql() throws Exception {
		...
		verify(fixture.statement).executeUpdate(contains("id VARCHAR(2048) NOT NULL UNIQUE"));
	}
	...
	void shouldUsePostgresqlInitializeTableSql() throws Exception {
		...
		verify(fixture.statement).executeUpdate(contains("id TEXT NOT NULL UNIQUE"));
	}
	...
	void shouldUseOracleInitializeTableSql() throws Exception {
		...
		verify(fixture.statement).executeUpdate(contains("id VARCHAR2(2000) NOT NULL UNIQUE"));
	}
